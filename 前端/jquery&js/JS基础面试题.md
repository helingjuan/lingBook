...
- [JS基础面试题](#js基础面试题)
  ...
  - [二.ES6基础](#二es6基础)
    ...
    - [ES6和TypeScript的区别](#es6和typescript的区别)
      - [es6的特点](#es6的特点)
      - [ts的特点](#ts的特点)
- [参考资料](#参考资料)
...
#### 箭头函数和普通函数的区别
1. this的指向不同，箭头函数的this是继承父级作用域的this，而普通函数的this指向的是使用它的对象，比如说函数的话，就是window对象，对象方法就是那个对象
2. 箭头函数不能当当做构造函数
3. 箭头函数不能使用arguments对象
4. 箭头函数不能使用yield命令
...
- 模块
- 变量的解构赋值
- 箭头函数，不再使用关键字function
- 默认函数参数

#### ts的特点
TypeScript是静态类型检查的弱类型
**相比于ES6,最大的改善是增加了类型系统**
- 类型
- 类
- 注解
- 模块导入
